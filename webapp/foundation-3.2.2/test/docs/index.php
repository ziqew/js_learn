...
<h5 class="subheader">We've got you covered when it comes to useful features and we've made it easy to take out what you don't need. Here's what you'll get when you create a project using our Gem or the default CSS version:</h5>

<div class="row">
    <div class="four columns">
        <dl>
            <dt><h5><a href="grid.php">The Grid</a></h5></dt>
    ...
    <div class="four columns">
        <dl>
            <dt><h5><a href="typography.php">Typography</a></h5></dt>
            <dd>Our type is based on a golden ratio modular scale that creates meaninful relationships for the copy on the page. It's easily updated using Scss or our CSS customizer.</dd>
        </dl>
    </div>
    <div class="four columns">
        <dl>
            <dt><h5><a href="buttons.php">Buttons</a></h5></dt>
...
<div class="row">
    <div class="four columns">
        <dl>
            <dt><h5><a href="navigation.php">Navigation</a></h5></dt>
    ...
    <div class="four columns">
        <dl>
            <dt><h5><a href="forms.php">Forms</a></h5></dt>
    ...
    <div class="four columns">
        <dl>
            <dt><h5><a href="elements.php">UI Elements</a></h5></dt>
...
<div class="row">
    <div class="four columns">
        <dl>
            <dt><h5><a href="tabs.php">Tabs</a></h5></dt>
...
<div class="row">
    <div class="four columns">
        <dl>
            <dt><h5><i class="foundicon-folder"></i> stylesheets</h5></dt>
    ...
    <div class="four columns">
        <dl>
            <dt><h5><i class="foundicon-folder"></i> javascripts</h5></dt>
            <dd>All of our plugins and the necessary Javascript to make Foundation work properly. The most important file here is <code>app.js</code>, which is used to initialize the various plugins that you might want to use. <strong>All JS is initiated by default</strong>.</dd>
        </dl>
    </div>
    <div class="four columns">
        <dl>
            <dt><h5><i class="foundicon-folder"></i> images</h5></dt>
            <dd>This directory includes all the images needed for Foundation, which actually aren't many. The only images included by default are used for Orbit. If you don't use Orbit, you may get rid of them.</dd>
        </dl>
    </div>
</div>
...
<div class="row">
    <div class="four columns">
        <dl>
            <dt><h5><i class="foundicon-page"></i> index.html</h5></dt>
    ...
    <div class="twelve columns">
        <div class="panel">
            ...
            <dl>
                ...
                <dd>Your main style folder is named <strong>sass/</strong> and contains <code>app.scss</code>, which imports Foundation (or the parts you want). Your custom styles go below the <code>@imports</code>. You can see the compiled CSS in your stylesheets directory after you manually <span class="has-tip top" title="$ compass compile <filename>">compile</span> or <span class="has-tip top" title="$ compass watch <directory>">watch</span>. This directory also includes <code>_settings.scss</code>, which is used to control variables that help easily style Foundation.</dd>
...
<div class="panel">
    ...
    <dl>
        <dt>CSS</dt>
        <dd>You'll only see <code>app.css</code> since we <strong>@import</strong> foundation at the top and it compiles above our custom CSS.</dd>
        <dt>JS</dt>
