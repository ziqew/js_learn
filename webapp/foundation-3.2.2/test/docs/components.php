...
<head>
  ...
  <title>Foundation Documentation: Components</title>
...
<body class="off-canvas">
    ...
    <section role="main">
      <div class="row">
        <div class="eight columns">
          ...
          <h5 class="subheader">Here's a rundown of components that come with Foundation. They're all designed to get out of the way and let you quickly prototype or customize to build what you need.</h5>

          <div class="row">
            <div class="six columns">
              <dl>
                <dt><h5><a href="grid.php">The Grid</a></h5></dt>
                <dd>Our grid is the core of Foundation and makes creating responsive websites a breeze.</dd>
              </dl>
            </div>
            <div class="six columns">
              <dl>
                <dt><h5><a href="media-queries.php">Media Queries</a></h5></dt>
                <dd>Foundation uses percentage widths to handle most layouts and a single breakpoint for small devices.</dd>
              </dl>
            </div>
          </div>
          ...
          <div class="row">
            <div class="six columns">
              <dl>
                ...
                <dd>Based on a modular scale, our typogrpahy comes with everything you need to handle copy on your site.</dd>
              </dl>
            </div>
            <div class="six columns">
              <dl>
                <dt><h5><a href="buttons.php">Buttons</a></h5></dt>
                <dd>Buttons are very common UI element and we've got you covered with plenty of styles to use.</dd>
              </dl>
            </div>
          </div>
          ...
          <div class="row">
            <div class="six columns">
              <dl>
                ...
                <dd>Our forms are styled to look great and work perfectly with the grid to create complex form layouts.</dd>
              </dl>
            </div>
            <div class="six columns">
              <dl>
                <dt><h5><a href="navigation.php">Navigation</a></h5></dt>
                <dd>Guiding people through your site or app is important, we've included lots of different navigation patterns.</dd>
              </dl>
            </div>
          </div>
          ...
          <div class="row">
            <div class="six columns">
              <dl>
                ...
                <dd>Tabs are great for separating content logically on a page. Foundation comes with a couple different options that will help you out.</dd>
              </dl>
            </div>
            <div class="six columns">
              <dl>
                <dt><h5><a href="elements.php">UI Elements</a></h5></dt>
                <dd>We've included lots of reusable UI elements that you can easily customize to make your own on each project.</dd>
              </dl>
            </div>
          </div>
          ...
          <div class="panel">
            <h3>Check out the Grid</h3>
            <h5 class="subheader">One of the most important parts of Foundation is the grid, why not take a little bit of time to read the docs to you understand how it works?</h5>
            <a class="button" href="grid.php">Learn about the grid &raquo;</a>
          </div>
        </div>
        <div class="four columns">
  ...
  <ul class="tabs vertical hide-on-phones">
    ...
    <li class="active"><a href="components.php">Components</a>
              <ul>
          <li class="active"><a href="components.php">Overview</a></li>
